        ...
        do {
            ...
            if (TABLA[fila][columna].charAt(0) == 's') {
                ...
                if (tipos_dato.indexOf(codigo[i]) != -1) {
                    ...
                    // etiqueta_else.push('Andy' + cont_var)
                    ...
                    if (codigo[i] == '{') {
                        ...
                        codigo_obj += tipo1 + ' Andy' + (cont_var) + ' ;\n';
                        //lo ideal seria verificar que posfija.pop() estuviese declarado en tabla variables
                        codigo_obj += 'Andy' + (cont_var) + ' = ' + posfija.pop() + ' ;\n';
                    ...
                    if (codigo[i] == '{') {
                        ...
                        if (posfija.length == 1) {
                            tipo1 = posfija_tipos.pop()
                            if (typeof tipo1 === 'undefined') tipo1 = posfija_tipos_booleanos.pop()
                            ASDeclararVariableAuxiliar('Andy' + (++cont_var), tipo1)
                            codigo_obj += tipo1 + ' Andy' + (cont_var) + ' ;\n';
                            codigo_obj += etidos + ':;\n'
                            codigo_obj += 'Andy' + (cont_var) + '=' + posfija.pop() + ' ;\n';
                    ...
                    if (ban_asignacion) {
                        ...
                        if (tabla_de_variables['Andy' + cont_var].Tipo == tabla_de_variables[id_asignar].Tipo) {
                            cod_obj_id_asigna += 'Andy' + cont_var;
    ...
    function A_L(ent) {
        ...
        if (palab_clave.indexOf(ent) != -1) {
            ...
            if (terminador /*;*/ == ent) {
                ...
                return ent
            } else if (RegEx_Variable.test(ent) && !RegEx_Numero_Int.test(ent) && boelanos.indexOf(ent) == -1 && !RegEx_Palabra.test(ent)) {
                if (tipo_dato_actual != '') {
        ...
        while (typeof (posfija[0]) !== "undefined") {
            if (operacion.indexOf(posfija[posfija.length - 1]) != -1) {
                ...
                if ((tipo1 == "int" || tipo1 == "float") && (tipo2 == "int" || tipo2 == "float")) {
                    ...
                    pilaS_booleanos.push(' Andy' + (++cont_var))
